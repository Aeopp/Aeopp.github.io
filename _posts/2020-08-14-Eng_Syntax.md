...
직관적으로도 과거시제로 표현된 be동사에 조동사로 뒤에 느낌을 덧붙여봤자 전혀 의미가 없단 걸 알 수 있다. 때문에 동사의 앞에 위치해 먼저 동사의 정확히 무엇을 의미하는 것인지 구체적으로 먼저 서술하는 것이다.

어떠한 조동사 뒤에도 일반동사든 be동사든 과거시제로 표현할려고 하면 문법을 떠나서 논리적으로  말이 되지 않는다는 것을 알 수 있다. 이미 ~할 수 있다 ~해야 한다 등
동사를 구체적으로 설명하였는데 동사가 갑자기 과거시제로 변화하면 쌩뚱맞아진다.

아마도 동사들의 과거형이 존재하지 않았다면 대신 조동사에 과거에 했다는 느낌을 전달해주는 조동사들이 존재하였을 것이다.
